...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react4.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React2.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var Popover = React3.forwardRef(({
  ...
  return (0, import_jsx_runtime2.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react9.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime6.jsxs)(import_jsx_runtime5.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react11.cloneElement)(children, triggerProps), (0, import_jsx_runtime4.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
//# sourceMappingURL=chunk-TLZS55UJ.js.map
