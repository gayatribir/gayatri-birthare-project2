import {
  Alert_default
} from "./chunk-B3SEJJPQ.js";
import {
  ButtonGroup_default
} from "./chunk-N2WQLR77.js";
import {
  DropdownButton_default
} from "./chunk-YX33UAT2.js";
import {
  ...
  useForceUpdate,
  usePopper_default
} from "./chunk-AWHOERPY.js";
import {
  Anchor_default,
  require_browser,
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-PIA5MWFD.js";
import {
...
} from "./chunk-5LAXXCT4.js";
import {
  contains,
  dataAttr,
  dataProp,
  qsa
} from "./chunk-ZBJCHW6H.js";
import {
  listen_default,
  ownerDocument,
  useCallbackRef,
...
var InputGroup = React19.forwardRef(({
  ...
  return (0, import_jsx_runtime19.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime19.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames17.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var Nav = React22.forwardRef((_ref, ref) => {
  ...
  const needsRefocusRef = (0, import_react12.useRef)(false);
  const parentOnSelect = (0, import_react12.useContext)(SelectableContext_default);
  const tabContext = (0, import_react12.useContext)(TabContext_default);
  ...
  const listNode = (0, import_react12.useRef)(null);
...
var NavLink = React25.forwardRef(({
  bsPrefix,
  className,
  ...
  return (0, import_jsx_runtime24.jsx)(Component2, {
    ...
    ...navItemProps,
    ref,
    className: (0, import_classnames20.default)(className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav2 = React26.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
Nav2.defaultProps = defaultProps11;
...
var NavbarBrand = React27.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React28.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context3 = (0, import_react14.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime27.jsx)(Collapse_default, {
...
var NavbarToggle = React29.forwardRef(({
  bsPrefix,
  className,
  children,
  label,
  ...
  return (0, import_jsx_runtime28.jsx)(Component2, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames23.default)(className, bsPrefix, !expanded && "collapsed"),
    children: children || (0, import_jsx_runtime28.jsx)("span", {
      className: `${bsPrefix}-icon`
    })
  });
});
NavbarToggle.displayName = "NavbarToggle";
NavbarToggle.defaultProps = defaultProps12;
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react17.useMemo)(function() {
...
var OffcanvasToggling = React30.forwardRef(({
  bsPrefix,
  className,
  children,
  ...props
  ...
  return (0, import_jsx_runtime29.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React30.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames24.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
OffcanvasToggling.defaultProps = defaultProps13;
...
var OffcanvasHeader = React31.forwardRef(({
  bsPrefix,
  className,
  ...props
}, ref) => {
...
OffcanvasHeader.defaultProps = defaultProps14;
...
function DialogTransition(props) {
  return (0, import_jsx_runtime31.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React32.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react18.useCallback)((backdropProps) => (0, import_jsx_runtime31.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames26.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime31.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames26.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime33.jsxs)(import_jsx_runtime32.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime31.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
Offcanvas.defaultProps = defaultProps15;
...
var NavbarOffcanvas = React33.forwardRef((props, ref) => {
  const context3 = (0, import_react19.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime34.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React34.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand,
    variant,
  ...
  return (0, import_jsx_runtime35.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime35.jsx)(SelectableContext_default.Provider, {
      value: handleCollapse,
      children: (0, import_jsx_runtime35.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames27.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
Navbar.defaultProps = defaultProps16;
...
var NavDropdown = React35.forwardRef(({
  ...
  return (0, import_jsx_runtime37.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames28.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime36.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime36.jsx)(Dropdown_default.Menu, {
      role: menuRole,
...
Popover.defaultProps = defaultProps17;
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react23.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
Overlay2.defaultProps = defaultProps18;
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime43.jsxs)(import_jsx_runtime42.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react25.cloneElement)(children, triggerProps), (0, import_jsx_runtime41.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
OverlayTrigger.defaultProps = defaultProps19;
...
PageItem.defaultProps = defaultProps20;
...
var Pagination = React42.forwardRef(({
  ...
  return (0, import_jsx_runtime46.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames32.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames33.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
Ratio.defaultProps = defaultProps22;
...
var Row = React47.forwardRef(({
  ...
  return (0, import_jsx_runtime51.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames36.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React48.forwardRef(({
  ...
  return (0, import_jsx_runtime52.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames37.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var Stack = React50.forwardRef(({
  ...
  return (0, import_jsx_runtime55.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames38.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
var Table = React56.forwardRef(({
  ...
  const classes = (0, import_classnames40.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime63.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
Tabs2.defaultProps = defaultProps24;
...
var ToastFade = React58.forwardRef((props, ref) => (0, import_jsx_runtime65.jsx)(Fade_default, {
  ...props,
  ref,
...
ToastHeader.defaultProps = defaultProps25;
...
var ToastContainer = React62.forwardRef(({
  ...
  return (0, import_jsx_runtime69.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames43.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
...
ToggleButtonGroup.defaultProps = defaultProps26;
...
Tooltip.defaultProps = defaultProps27;
